...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing is True:
            ...
            #self.epsilon = self.epsilon - 0.05  #First decay function defined by notebook
            self.t = self.t + 1.0
            #self.epsilon=self.epsilon - math.exp(-1*self.t*self.alpha)
            self.epsilon = math.fabs(math.acos(self.alpha * self.t))
    ...
    def build_state(self):
        ...
        state = (inputs['oncoming'], inputs['light'],inputs['left'], waypoint)
...
def run():
    ...
    sim.run(n_test=80,tolerance=0.005)
